...
public class UserModel {
    ...
    public UserModel(AdminModel am, AuthKey user_auth_key) {
    ...
    public UserModel(StudentsModel sm, AuthKey user_auth_key) {
        this.username = sm.getUsername();
        this.name = sm.getName();
        this.surname = sm.getSurname();
        this.grade = "N/A";
        this.valid = sm.isValid();
        this.user_auth_key = user_auth_key;
    }
